  ...
  return (
    <Formik
      ...
      validationSchema={Yup.object({
        name: Yup.string().length(3, "must be at least 3 letter"),
        personCode: Yup.number().integer("Integer number require ------"),
        codeMelli: Yup.string()
          .matches(/^[0-9]+$/, "Must be only digits")
          .min(10, "Must be exactly 5 digits")
          .max(10, "Must be exactly 5 digits"),
        birthdayDate: Yup.string().matches(
        ...
        address: Yup.string().min(10, "address should be more than 10 word"),
      })}
